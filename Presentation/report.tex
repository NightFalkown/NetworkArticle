...
\begin{itemize}
	...
	\item $\beta_i$ : Pente du RTT minimum jusqu'au hop i. %TODO Meilleure explication souhaitée. 
\end{itemize}
...
%layer 2 switches " %TODO voir plus en profondeur" introduisant
%des délais de sérialisation. 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%droite %TODO "fittant le mieux l'évolution linéaire".
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%Pourquoi (N-1) pour N paquets ? On ne prend pas en compte le 1er paquet,
%juste son dernier bit (ex avec deux paquets on ne prend que 1*L).
